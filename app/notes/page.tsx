...
import NewsHeadline from "@/components/site/NewsHeadline";
          ...
          >
            ...
            <div className="min-w-0">
              {/* Content text matches the Bio section: JetBrains Mono 13/22.
                  ...
                  When it also has an image, clicking opens the article in a new
                  tab and raises the terminal-style Image Popup over this page. */}
              <div className="font-mono text-[13px] leading-[22px]">
                <NewsHeadline
                  headline={n.headline}
                  href={n.href || undefined}
                  image={n.image || undefined}
                  venue={n.venue || undefined}
                />
              </div>
              {n.venue && (
